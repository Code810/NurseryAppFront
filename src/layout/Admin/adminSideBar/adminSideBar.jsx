                ...
                <div className="space-y-8">
                    ...
                    <div>
                        ...
                        <ul className="mt-3">
                            ...
                            <MenuNavItem text="Mesajlar" path="/admin/messages" Icon={AiFillMessage} />
                                <div className="flex flex-shrink-0 ">
                                            <span className="inline-flex items-center justify-center h-4 text-xs font-medium text-white bg-[#ed145b] px-2 rounded">4</span>
                                </div>
                            </li>
